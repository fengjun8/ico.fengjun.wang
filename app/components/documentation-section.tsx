  ...
  return (
    <div className="bg-white rounded-lg shadow">
      <div className="p-6 prose prose-gray max-w-none">
        <h2 className="text-2xl font-bold mb-4">什么是Favicon？</h2>
        <p>
          Favicon（favorite icon的缩写）是一个在浏览器标签页、书签和其他界面元素中显示的小图标。
          它帮助用户在多个打开的标签页和书签中快速识别您的网站。
        </p>

        <h3 className="text-xl font-bold mt-6 mb-4">如何使用Favicon</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">最佳实践</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">支持的格式</h3>
        <p>我们的转换工具支持以下输入格式：</p>
        <ul className="list-disc pl-6 space-y-2">
          <li>JPEG（.jpg、.jpeg）</li>
          <li>PNG（.png）</li>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">尺寸指南</h3>
        <p>我们支持转换为以下ICO尺寸：</p>
        <ul className="list-disc pl-6 space-y-2">
